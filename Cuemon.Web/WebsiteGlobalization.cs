...
namespace Cuemon.Web
{
	...
	public sealed class WebsiteGlobalization : XmlSerialization
	{
		...
		private XmlFile defaultPhraseStyleSheetFileValue;
		...
		public XmlFile DefaultPhraseStyleSheetFile
		{
			get
			{
				if (defaultPhraseStyleSheetFileValue == null)
				{
					...
					defaultPhraseStyleSheetFileValue = new XmlFile(file);
				}
				return defaultPhraseStyleSheetFileValue;
			}
		}
		#endregion
		...
		public override void WriteXml(XmlWriter writer)
		{
			...
			writer.WriteRaw(this.DefaultCultureInfo.ToString(this.DefaultCultureInfo.ToXml(true, new XmlQualifiedEntity("DefaultCultureInfo")), PreambleSequence.Remove));
			writer.WriteRaw(this.DefaultTimeZone.ToString(this.DefaultTimeZone.ToXml(true, new XmlQualifiedEntity("DefaultTimeZone")), PreambleSequence.Remove)); 
			writer.WriteRaw(this.CurrentCultureInfo.ToString(this.CurrentCultureInfo.ToXml(true, new XmlQualifiedEntity("CurrentCultureInfo")), PreambleSequence.Remove));
			writer.WriteRaw(this.CurrentTimeZone.ToString(this.CurrentTimeZone.ToXml(true, new XmlQualifiedEntity("CurrentTimeZone")), PreambleSequence.Remove));
			writer.WriteRaw(this.CultureInfos.ToString(this.CultureInfos.ToXml(true), PreambleSequence.Remove));
			writer.WriteRaw(this.TimeZones.ToString(this.TimeZones.ToXml(true), PreambleSequence.Remove));           
		}
		#endregion
	}
}