...
namespace Cuemon.Web.Security
{
    ...
    public sealed class JsonWebToken
    {
        ...
        {
            ValidateJwtParameters(base64UrlEncodedHeader, base64UrlEncodedPayload, algorithm, secret);
            return HmacUtility.ComputeKeyedHash(Tokenize(base64UrlEncodedHeader, base64UrlEncodedPayload), secret, JsonWebTokenHashAlgorithmConverter.ToHmacAlgorithm(algorithm), Encoding.UTF8).ToUrlEncodedBase64();
        }
        ...
        public string ToString(string base64UrlEncodedHeader, string base64UrlEncodedPayload, JsonWebTokenHashAlgorithm algorithm, byte[] secret)
        {
            ...
            return algorithm == JsonWebTokenHashAlgorithm.None ? tokenString : string.Format(CultureInfo.InvariantCulture, "{0}.{1}", tokenString, ComputeSignature(base64UrlEncodedHeader, base64UrlEncodedPayload, algorithm, secret));
        }
