...
namespace Cuemon.Web
{
    ...
    /// </summary>
    [XmlRoot("Binding")]
    [XmlSerialization(DefaultSerializationMethod = XmlSerializationMethod.XmlAttribute, EnableAutomatedXmlSerialization = true)]
    public sealed class WebsiteBinding : XmlSerialization
    {
        ...
        public WebsiteBinding(string protocolType, string hostHeader)
        {
            ...
            if (hostHeader == null) { throw new ArgumentNullException(nameof(hostHeader)); }
