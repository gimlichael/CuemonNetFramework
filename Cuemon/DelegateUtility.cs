...
namespace Cuemon
{
    ...
    public static class DelegateUtility
    {
        ...
        public static TResult SafeInvokeDisposable<TResult>(Doer<TResult> initializer) where TResult : class, IDisposable
        {
        ...
        /// <returns>The return value of the function delegate <paramref name="initializer"/>.</returns>
        public static TResult SafeInvokeDisposable<T, TResult>(Doer<T, TResult> initializer, T arg) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            TResult result;
            TResult temp = null;
        ...
        /// <returns>The return value of the function delegate <paramref name="initializer"/>.</returns>
        public static TResult SafeInvokeDisposable<T1, T2, TResult>(Doer<T1, T2, TResult> initializer, T1 arg1, T2 arg2) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            TResult result;
            TResult temp = null;
        ...
        /// <returns>The return value of the function delegate <paramref name="initializer"/>.</returns>
        public static TResult SafeInvokeDisposable<T1, T2, T3, TResult>(Doer<T1, T2, T3, TResult> initializer, T1 arg1, T2 arg2, T3 arg3) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            TResult result;
            TResult temp = null;
        ...
        /// <returns>The return value of the function delegate <paramref name="initializer"/>.</returns>
        public static TResult SafeInvokeDisposable<T1, T2, T3, T4, TResult>(Doer<T1, T2, T3, T4, TResult> initializer, T1 arg1, T2 arg2, T3 arg3, T4 arg4) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            TResult result;
            TResult temp = null;
        ...
        /// <returns>The return value of the function delegate <paramref name="initializer"/>.</returns>
        public static TResult SafeInvokeDisposable<T1, T2, T3, T4, T5, TResult>(Doer<T1, T2, T3, T4, T5, TResult> initializer, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            TResult result;
            TResult temp = null;
        ...
        public static TOptions ConfigureAction<TOptions>(Act<TOptions> setup, Act<TOptions> initializer = null)
        {
