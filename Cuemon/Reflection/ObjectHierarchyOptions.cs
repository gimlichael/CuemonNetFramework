...
namespace Cuemon.Reflection
{
    ...
    public class ObjectHierarchyOptions
    {
        ...
        private Doer<Type, bool> _skipPropertyType;
        private Doer<PropertyInfo, bool> _skipProperty;
        private Doer<object, bool> _hasCircularReference;
        private Doer<ParameterInfo[], object[]> _propertyIndexParametersResolver;
        ...
        /// </summary>
        /// <value>A <see cref="Doer{TResult}"/> that determines if a given property <see cref="Type"/> should be skipped or not.</value>
        public Doer<Type, bool> SkipPropertyType
        {
        ...
        /// </summary>
        /// <value>A <see cref="Doer{TResult}"/> that determines if a given <see cref="PropertyInfo"/> should be skipped or not.</value>
        public Doer<PropertyInfo, bool> SkipProperty
        {
        ...
        /// </summary>
        /// <value>A <see cref="Doer{TResult}"/> that determines if an object is suggesting a circular reference.</value>
        public Doer<object, bool> HasCircularReference
        {
        ...
        /// </summary>
        /// <value>A <see cref="Doer{TResult}"/> that will resolve the index parameters of a <see cref="PropertyInfo"/>.</value>
        public Doer<ParameterInfo[], object[]> PropertyIndexParametersResolver
        {
