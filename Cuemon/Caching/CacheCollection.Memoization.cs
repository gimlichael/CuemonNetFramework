...
namespace Cuemon.Caching
{
    public sealed partial class CacheCollection
    {
        ...
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<TResult> Memoize<TResult>(Doer<TResult> method, params Dependency[] dependencies)
        {
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T, TResult> Memoize<T, TResult>(Doer<T, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, TResult> Memoize<T1, T2, TResult>(Doer<T1, T2, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, TResult> Memoize<T1, T2, T3, TResult>(Doer<T1, T2, T3, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, T4, TResult> Memoize<T1, T2, T3, T4, TResult>(Doer<T1, T2, T3, T4, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, T4, T5, TResult> Memoize<T1, T2, T3, T4, T5, TResult>(Doer<T1, T2, T3, T4, T5, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, T4, T5, T6, TResult> Memoize<T1, T2, T3, T4, T5, T6, TResult>(Doer<T1, T2, T3, T4, T5, T6, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, T4, T5, T6, T7, TResult> Memoize<T1, T2, T3, T4, T5, T6, T7, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, T4, T5, T6, T7, T8, TResult> Memoize<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, T8, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> Memoize<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }
        ...
        /// <param name="dependencies">Establishes one or more <see cref="Dependency"/> relations to this memoized function delegate.</param>
        /// <returns>A memoized function delegate that is otherwise equivalent to <paramref name="method"/>.</returns>
        public Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> Memoize<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> method, params Dependency[] dependencies)
        {
            return MemoizeCore(method, DateTime.MaxValue, TimeSpan.Zero, dependencies);
        }

        private Doer<TResult> MemoizeCore<TResult>(Doer<TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
            return delegate()
            {
                lock (InnerCaches)
                {
                    ...
                    {
                        result = method();
                        this.AddCore(key, result, MemoizationGroup, absoluteExpiration, slidingExpiration, dependencies);
                    }
                    return result;
                }
            };
        ...
        private Doer<T, TResult> MemoizeCore<T, TResult>(Doer<T, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, TResult> MemoizeCore<T1, T2, TResult>(Doer<T1, T2, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, TResult> MemoizeCore<T1, T2, T3, TResult>(Doer<T1, T2, T3, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, T4, TResult> MemoizeCore<T1, T2, T3, T4, TResult>(Doer<T1, T2, T3, T4, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, T4, T5, TResult> MemoizeCore<T1, T2, T3, T4, T5, TResult>(Doer<T1, T2, T3, T4, T5, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, T4, T5, T6, TResult> MemoizeCore<T1, T2, T3, T4, T5, T6, TResult>(Doer<T1, T2, T3, T4, T5, T6, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, T4, T5, T6, T7, TResult> MemoizeCore<T1, T2, T3, T4, T5, T6, T7, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, T4, T5, T6, T7, T8, TResult> MemoizeCore<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, T8, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> MemoizeCore<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> MemoizeCore<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(Doer<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> method, DateTime absoluteExpiration, TimeSpan slidingExpiration, params Dependency[] dependencies)
        {
        ...
        private static string CalculateCompositeKey(params object[] args)
        {
            ...
            for (int i = 0; i < args.Length; i++)
            {
                ...
                result ^= bytes == null ? current.GetHashCode() : ByteUtility.GetHashCode(bytes);
            }
