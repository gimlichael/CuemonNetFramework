...
namespace Cuemon
{
    ...
    public class TransientFaultEvidence
    {
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0} was invoked {1} time(s) over a period of {2}. Last recovery wait time was {3}, giving a total recovery wait time of {4}. Latency was {5}.",
                Member,
                Attempts,
