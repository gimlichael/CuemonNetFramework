    ...
    public static class Converter
    {
        ...
        public static T FromString<T>(string value, CultureInfo culture, ITypeDescriptorContext context)
        {
            try
            {
                ...
                System.ComponentModel.TypeConverter converter = TypeDescriptor.GetConverter(resultType);
            ...
            catch (Exception ex)
            {
                ...
                throw ExceptionUtility.Refine(ExceptionUtility.CreateArgumentException(nameof(value), ex.Message, ex.InnerException), MethodBase.GetCurrentMethod(), value, culture, context);
            }
        }
        ...
        /// <remarks>This method first checks if <paramref name="value"/> is compatible with <typeparamref name="TResult"/>; if not compatible the method continues with <see cref="ObjectConverter.ChangeType(object,System.Type,System.IFormatProvider)"/> for the operation.</remarks>
