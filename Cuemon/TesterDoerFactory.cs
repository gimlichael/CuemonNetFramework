...
namespace Cuemon
{
    ...
    public static class TesterDoerFactory
    {
        ...
        {
            return new TesterDoerFactory<Template, TResult, TSuccess>((Template tuple, out TResult result) => method(out result), TupleUtility.CreateZero(), method != null);
        }
        ...
        {
            return new TesterDoerFactory<Template<T>, TResult, TSuccess>((Template<T> tuple, out TResult result) => method(tuple.Arg1, out result), TupleUtility.CreateOne(arg), method != null);
        }
        ...
        {
            return new TesterDoerFactory<Template<T1, T2>, TResult, TSuccess>((Template<T1, T2> tuple, out TResult result) => method(tuple.Arg1, tuple.Arg2, out result), TupleUtility.CreateTwo(arg1, arg2), method != null);
        }
        ...
        {
            return new TesterDoerFactory<Template<T1, T2, T3>, TResult, TSuccess>((Template<T1, T2, T3> tuple, out TResult result) => method(tuple.Arg1, tuple.Arg2, tuple.Arg3, out result), TupleUtility.CreateThree(arg1, arg2, arg3), method != null);
        }
        ...
        {
            return new TesterDoerFactory<Template<T1, T2, T3, T4>, TResult, TSuccess>((Template<T1, T2, T3, T4> tuple, out TResult result) => method(tuple.Arg1, tuple.Arg2, tuple.Arg3, tuple.Arg4, out result), TupleUtility.CreateFour(arg1, arg2, arg3, arg4), method != null);
        }
        ...
        {
            return new TesterDoerFactory<Template<T1, T2, T3, T4, T5>, TResult, TSuccess>((Template<T1, T2, T3, T4, T5> tuple, out TResult result) => method(tuple.Arg1, tuple.Arg2, tuple.Arg3, tuple.Arg4, tuple.Arg5, out result), TupleUtility.CreateFive(arg1, arg2, arg3, arg4, arg5), method != null);
        }
        ...
        {
            return new TesterDoerFactory<Template<T1, T2, T3, T4, T5, T6>, TResult, TSuccess>((Template<T1, T2, T3, T4, T5, T6> tuple, out TResult result) => method(tuple.Arg1, tuple.Arg2, tuple.Arg3, tuple.Arg4, tuple.Arg5, tuple.Arg6, out result), TupleUtility.CreateSix(arg1, arg2, arg3, arg4, arg5, arg6), method != null);
        }
        ...
        {
            return new TesterDoerFactory<Template<T1, T2, T3, T4, T5, T6, T7>, TResult, TSuccess>((Template<T1, T2, T3, T4, T5, T6, T7> tuple, out TResult result) => method(tuple.Arg1, tuple.Arg2, tuple.Arg3, tuple.Arg4, tuple.Arg5, tuple.Arg6, tuple.Arg7, out result), TupleUtility.CreateSeven(arg1, arg2, arg3, arg4, arg5, arg6, arg7), method != null);
        }
    ...
    public class TesterDoerFactory<TTuple, TResult, TSuccess> : TemplateFactory<TTuple> where TTuple : Template
    {
        ...
        /// <param name="method">The tester function delegate to invoke.</param>
        /// <param name="tuple">The n-tuple argument of <paramref name="method"/>.</param>
        public TesterDoerFactory(TesterDoer<TTuple, TResult, TSuccess> method, TTuple tuple) : this(method, tuple, method != null)
        {
        }
        ...
        internal TesterDoerFactory(TesterDoer<TTuple, TResult, TSuccess> method, TTuple tuple, bool hasDelegate) : base(tuple, hasDelegate)
        {
            Method = method;
