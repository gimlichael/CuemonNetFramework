...
namespace Cuemon.Globalization
{
    ...
    {
        internal static readonly PadLock<IEnumerable<CultureInfo>> SpecificCultures = new PadLock<IEnumerable<CultureInfo>>(() =>
        {
        ...
        private static readonly PadLock<IEnumerable<RegionInfo>> SpecificRegions = new PadLock<IEnumerable<RegionInfo>>(() =>
        {
        ...
        public static IEnumerable<CultureInfo> GetCultures(RegionInfo region)
        {
            ...
            return EnumerableUtility.Where(SpecificCultures.Value, c => c.Name.EndsWith(region.TwoLetterISORegionName));
        }
    }
}