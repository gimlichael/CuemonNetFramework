...
namespace Cuemon.Globalization
{
    ...
    public static class GlobalizationUtility
    {
        ...
        {
            if (!HasCurrency(threeLetterIsoCode)) { throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "No currency could be resolved by the provided three-letter ISO currency code: {0}.", threeLetterIsoCode), nameof(threeLetterIsoCode)); }
        ...
        {
            if (!HasCurrency(isoCode)) { throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "No currency could be resolved by the provided ISO currency code: {0}.", isoCode), nameof(isoCode)); }
        ...
        {
            if (threeLetterIsoCode == null) { throw new ArgumentNullException(nameof(threeLetterIsoCode)); }
            if (threeLetterIsoCode.Length != 3) { throw new ArgumentException("The length of the ISO code must be exactly 3, hence the name.", nameof(threeLetterIsoCode)); }
        ...
        {
            Validator.ThrowIfNullOrEmpty(twoOrThreeLetterIsoCode, nameof(twoOrThreeLetterIsoCode));
            Validator.ThrowIfLowerThan(twoOrThreeLetterIsoCode.Length, 2, nameof(twoOrThreeLetterIsoCode), "The length of the ISO code must be either 2 or 3.");
            Validator.ThrowIfGreaterThan(twoOrThreeLetterIsoCode.Length, 3, nameof(twoOrThreeLetterIsoCode), "The length of the ISO code must be either 2 or 3.");
