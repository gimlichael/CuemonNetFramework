...
namespace Cuemon.Security
{
    ...
    public sealed class SecurityTokenSettings
    {
        ...
        {
            Validator.ThrowIfLowerThanOrEqual(timeToLive.Ticks, 0, "timeToLive", "Token must have a TTL larger than 0.");
            Validator.ThrowIfLowerThan(lengthOfToken, 4, "lengthOfToken", "Token must have a length of at least 4.");
            Validator.ThrowIfGreaterThan(lengthOfToken, 1024, "lengthOfToken", "Token cannot exceed the length of 1024.");
            if (reference == null) { reference = ""; }

            this.TimeToLive = timeToLive;
            this.LengthOfToken = lengthOfToken;
