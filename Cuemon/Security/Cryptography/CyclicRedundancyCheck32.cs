...
namespace Cuemon.Security.Cryptography
{
    ...
    public sealed class CyclicRedundancyCheck32 : CyclicRedundancyCheck
    {
        ...
        /// </summary>
        public CyclicRedundancyCheck32() : base()
        {
        }
        ...
        protected override void InitializePolynomial()
        {
            switch (this.Representation)
            {
                ...
                case PolynomialRepresentation.ReversedReciprocal:
                    this.Polynomial = 0x82608EDB;
                    break;
                default:
                    throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "The specified CRC representation is invalid. Expected value must be one of the following: Normal, Reversed or ReversedReciprocal. Actually value was: {0}.", this.Representation));
            }
        }
        ...
        {
            bool hasIndex = ListUtility.HasIndex(currentTableIndex, this.LookupTable);
            if (!hasIndex) { this.LookupTable.Add(currentTableIndex); }
            long value = this.LookupTable[currentTableIndex];
            if ((value & 1) == 1)
            {
            ...
            this.LookupTable[currentTableIndex] = value;
        }
        ...
        protected override void HashCore(byte[] array, int ibStart, int cbSize)
        {
            ...
            unchecked
            {
                ...
                {
                    this.HashCoreResult = ((this.HashCoreResult) >> 8) ^ this.LookupTable[(int)((array[i]) ^ ((this.HashCoreResult) & 0x000000FF))];
                }
            }
