...
{
	/// <summary>
	/// This utility class is designed to make <see cref="Rijndael"/> operations easier to work with.
	/// </summary>
	public static class AdvancedEncryptionStandardUtility
	{
		...
		{
			return ConvertUtility.ToByteArray(StringUtility.CreateRandomString(BlockSize / 8), PreambleSequence.Remove, Encoding.UTF8);
		}
		...
		{
			if (keySize > AdvancedEncryptionStandardKeySize.AES256 || keySize < AdvancedEncryptionStandardKeySize.AES128) { throw new ArgumentOutOfRangeException("keySize", "Specified argument was out of the range of valid values."); }
			string result;
			switch (keySize)
			{
            ...
            return ConvertUtility.ToByteArray(result, PreambleSequence.Remove, Encoding.UTF8);
		}
