...
namespace Cuemon
{
    ...
    public static class NumberUtility
    {
        ...
        {
            return IsCountableSequence(EnumerableUtility.Select(source, CastAsIntegralSequence));
        }
        ...
        {
            return EnumerableUtility.Max(values);
        }
        ...
        {
            return EnumerableUtility.Min(values);
        }
