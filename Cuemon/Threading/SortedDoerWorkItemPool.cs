...
namespace Cuemon.Threading
{
	...
	public sealed class SortedDoerWorkItemPool<TKey, TResult> : DoerWorkItemPool<TResult>, ISortedDoerWorkItemPool<TKey, TResult>
	{
		...
		public SortedDoerWorkItemPool(IComparer<TKey> comparer) : base()
		{
		...
		{
			get { return new ReadOnlyCollection<TResult>(this.PreliminaryResult.Values); }
		}
		...
		internal void AddResult(TKey key, TResult value)
		{
			...
			{
				this.PreliminaryResult.Add(key, value);
			}
		}
