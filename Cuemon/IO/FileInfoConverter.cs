...
namespace Cuemon.IO
{
    ...
    public static class FileInfoConverter
    {
        ...
        public static T Convert<T>(string fileName, Doer<FileInfo, byte[], T> converter)
        {
        ...
        /// <param name="converter">The function delegate that will handle the conversion.</param>
        /// <returns>An instance of <typeparamref name="T"/>.</returns>
        public static T Convert<T>(string fileName, int bytesToRead, Doer<FileInfo, byte[], T> converter)
        {
