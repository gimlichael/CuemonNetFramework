...
namespace Cuemon
{
    ...
    public class TransientFaultHandlingOptions
    {
        ...
        public Doer<int, TimeSpan> RecoveryWaitTimeCallback { get; set; }
        ...
        /// </summary>
        /// <value>A <see cref="Doer{TResult}"/> that parses an <see cref="Exception"/> for clues that would suggest a transient fault.</value>
        /// <remarks>Default implementation is fixed to none-transient failure.</remarks>
        public Doer<Exception, bool> TransientFaultParserCallback { get; set; }
    }
}