...
namespace Cuemon.Data.SqlCeClient
{
    ...
    public class SqlCeDataManager : DataManager
    {
        ...
        {
            return ExecuteIdentity<int>(dataCommand, parameters);
        }
        ...
        {
            return ExecuteIdentity<long>(dataCommand, parameters);
        }
        ...
        {
            return ExecuteIdentity<decimal>(dataCommand, parameters);
        }
        ...
        private T ExecuteIdentity<T>(IDataCommand dataCommand, params IDataParameter[] parameters)
        {
            ...
            try
            {
                using (TransactionScope transaction = new TransactionScope())
                {
                    ...
                    using (IDbCommand command = ExecuteCommandCore(new DataCommand("SELECT @@IDENTITY", CommandType.Text, dataCommand.Timeout)))
                    {
        ...
        {
            return new SqlCeDataManager(ConnectionString);
        ...
        protected override IDbCommand GetCommandCore(IDataCommand dataCommand, params IDataParameter[] parameters)
        {
            ...
            try
            {
                tempCommand = new SqlCeCommand(dataCommand.Text, new SqlCeConnection(ConnectionString));
