...
{
    /// <summary>
    /// A Microsoft SQL CE implementation of the <see cref="QueryBuilder"/> class.
    /// </summary>
    public class SqlCeQueryBuilder : QueryBuilder
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlCeQueryBuilder"/> class.
        /// </summary>
        public SqlCeQueryBuilder()
        {
        }
        ...
        /// <param name="keyColumns">The key columns to be used in this <see cref="SqlCeQueryBuilder"/> instance.</param>
        public SqlCeQueryBuilder(string tableName, IDictionary<string, string> keyColumns)
        ...
        /// <param name="tableName">The name of the table or view.</param>
        /// <param name="keyColumns">The key columns to be used in this <see cref="SqlCeQueryBuilder"/> instance.</param>
        /// <param name="columns">The none-key columns to be used in this <see cref="SqlCeQueryBuilder"/> instance.</param>
        public SqlCeQueryBuilder(string tableName, IDictionary<string, string> keyColumns, IDictionary<string, string> columns)
