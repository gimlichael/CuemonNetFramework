...
namespace Cuemon.Xml
{
    ...
    public static class XmlUtility
    {
        ...
        {
            return CreateXmlReader(StreamConverter.FromBytes(value));
        }
        ...
        public static string SanitizeElementName(string elementName)
        {
            ...
            if (StringUtility.StartsWith(elementName, StringComparison.OrdinalIgnoreCase, EnumerableUtility.Concat(StringConverter.FromChars(StringUtility.NumericCharacters), new string[1] { "." })))
            {
                int startIndex = 0;
