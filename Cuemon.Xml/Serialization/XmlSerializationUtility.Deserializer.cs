    ...
    public static partial class XmlSerializationUtility
    {
        ...
        private static PropertyInfo GetReaderEquivalentProperty(string localName, IEnumerable<PropertyInfo> properties)
        {
            foreach (PropertyInfo property in properties)
            {
                ...
                if (hasAttributeAttribute) { propertyName = ReflectionUtility.GetAttribute<XmlAttributeAttribute>(property.PropertyType).AttributeName; }
                if (hasElementAttribute) { propertyName = ReflectionUtility.GetAttribute<XmlElementAttribute>(property.PropertyType).ElementName; }
