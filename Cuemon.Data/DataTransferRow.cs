...
namespace Cuemon.Data
{
    ...
    {
        internal DataTransferRow(IDataRecord record, int rowNumber, ref IList<KeyValuePair<string, Type>> columns)
        {
            this.Columns = new DataTransferColumnCollection(record, ref columns);
        ...
        public override string ToString()
        {
            ...
            {
                DataTransferColumn column = this.Columns.Get(i);
