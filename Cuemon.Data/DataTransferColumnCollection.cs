...
namespace Cuemon.Data
{
    ...
    public sealed class DataTransferColumnCollection : IEnumerable<DataTransferColumn>
    {
        ...
        internal DataTransferColumnCollection(IDataRecord record, ref IList<KeyValuePair<string, Type>> columns)
        {
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                this.DataTransferColumns.Add(new DataTransferColumn(i, columnName, record == null ? TypeUtility.GetDefaultValue(columnType) : record.IsDBNull(i) ? null : record.GetValue(i), columnType));
            }
        }
        ...
        {
            return this.DataTransferColumns[index];
        }
        ...
        public object this[string name]
        {
            get
            {
                DataTransferColumn column = this.Get(name);
        ...
        public object this[int index]
        {
            get
            {
                DataTransferColumn column = this.Get(index);
                return column == null ? null : column.Value;
            }
        }
        ...
        {
            return this.DataTransferColumns.Contains(item);
        }
        ...
        public int Count
        {
            get { return this.DataTransferColumns.Count; }
        }
        ...
        {
            return this.DataTransferColumns.GetEnumerator();
        }
        ...
        {
            return this.DataTransferColumns.IndexOf(item);
        }
